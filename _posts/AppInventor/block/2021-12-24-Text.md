...
이 문자열에는 모든 문자(문자, 숫자 또는 기타 특수 문자)가 포함될 수 있습니다. App Inventor에서는 텍스트 개체로 간주됩니다.|||
...
|<img width="66" alt="text_length" src="https://user-images.githubusercontent.com/55564114/147333471-c787086e-bd06-434b-9fec-3640f46561da.png">| 문자열의 공백을 포함한 문자 수를 반환합니다. 이것은 주어진 텍스트 문자열의 길이입니다.| 숫자(int) | |
...
|<img width="241" alt="text_compare" src="https://user-images.githubusercontent.com/55564114/147333606-6b7b9d5a-1eec-4dd1-8b4c-45dc7ee64ab5.png">|선택한 드롭다운에 따라 첫 번째 문자열이 사전순으로 <, >, = 또는 ≠ 두 번째 문자열인지 여부를 반환합니다.

다른 문자열보다 사전순으로 더 큰 경우 사전순으로 다른 문자열보다 더 큰 것으로 간주되는 문자열입니다. 기본적으로 그것은 사전 뒤에 올 것입니다. 모든 대문자는 더 작은 것으로 간주되거나 소문자보다 먼저 표시됩니다. |||
